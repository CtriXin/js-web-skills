...
var Toast = {
    show: function (options)
    {
        ...
        var icon = '<div class="toast-icon">' + toastDefaultIcon + '</div>';
        toastClasses.push('toast-mobile');

        $toast.html(icon + title);
        //toast class
        var type = 'toast-type-warn';
        toastClasses.push(type);
        var position ='toast-y-bottom toast-x-center';
