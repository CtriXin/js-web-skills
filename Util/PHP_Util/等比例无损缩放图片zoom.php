...
var_export(getimagesize('1.jpg'));
$rate=3;//这样长宽等比例缩放就不需要填充了
// 测试
imagezoom('1.jpg', '2.jpg', getimagesize('1.jpg')[0]*$rate, getimagesize('1.jpg')[1]*$rate, '#CF3061');
...
/*
    ...
    param:
        ...
        @dst_width: 缩小宽
        @dst_height: 缩小高
        @backgroundcolor: 补充色  如：#FFFFFF白色  支持 6位  不支持3位
*/
