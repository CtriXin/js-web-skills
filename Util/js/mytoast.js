...
function $S(s){return document.getElementById(s);}
		...
		function checkIsElecmentExist(){
			if($S('toast_id')==null){
				...
				createDiv.innerHTML='<div id="toast_id" class="toasttj" style="display: none; opacity: 0;z-index:1003;font-size: 1.37em;position: fixed;bottom:25%;width: 100%;opacity:0;height: 24px;display: none;-webkit-transition: opacity .5s ease-out .5s;text-align: center;"><a id="toast_value" style="color:#fff;background-color:#CACACA ;border-radius: 20px;padding: 10px;text-align: center;margin: 0 auto;display: inline-block;box-shadow: 3px 3px 3px #888888;"></a></div>';  
